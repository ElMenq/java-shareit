...
public class ItemRequestController {
    ...
    @PostMapping
    public ResponseEntity<ItemRequestDto> create(@RequestHeader(HttpHeadersConstants.X_SHARER_USER_ID) long userId,
    ...
    @GetMapping
    public ResponseEntity<List<ItemRequestDto>> getAll(@RequestHeader(HttpHeadersConstants.X_SHARER_USER_ID) long userId) {
    ...
    public ResponseEntity<ItemRequestDto> getItemRequest(@RequestHeader(HttpHeadersConstants.X_SHARER_USER_ID) long userId,
    ...
    @GetMapping("/all")
    public ResponseEntity<List<ItemRequestDto>> search(@RequestHeader(HttpHeadersConstants.X_SHARER_USER_ID) long userId,
